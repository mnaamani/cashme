// The CLI grammar: what commands exist and what flags they take. No behaviour lives here —
// each command's implementation is a module of the same name in this directory, wired up by
// the dispatch table in bin.mjs.
