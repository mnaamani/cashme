...
// TODO: raw proofs do not contain metadata about which mint they are associated with
// to support multiple mints, store proofs keyed by mint url?
// flat file is okay while developing, but we need a reliable store that can be locked
// while an instance of the program is running or we risks proofs going "poof!"
// using a corestore based store would be nice, replicating the proofs easily at a backup 'wallet' location
// like a mobile app ? ;)
