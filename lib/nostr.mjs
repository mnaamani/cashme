...
//
// Deliberately not a nostr client. Nothing here subscribes for long, keeps profiles, or
// verifies anyone else's signatures — `cashme nutzap` reads one event kind (10019, where a
// user says how to nutzap them) and writes one (9321, the nutzap itself), and that is the
// whole surface.
