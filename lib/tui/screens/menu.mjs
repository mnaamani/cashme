...
const GROUPS = [
  [
    ...
    { route: 'mints', label: 'mints', hint: 'who this wallet trusts, and what each holds' },
    { route: 'relays', label: 'relays', hint: 'the nostr relays this wallet asks' },
  ...
  [
    ...
    { route: 'get', label: 'get', hint: 'claim a token someone gave you' },
