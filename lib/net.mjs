...
// here". CASHME_PROXY is the only variable this module reads directly — everything the
// convention itself defines goes through bare-proxy-from-env, which has the same rule.
// lib/updater.mjs reads CASHME_NO_UPDATES by the same rule, with its own copy of it.
function env(name) {
