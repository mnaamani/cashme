...
export const ACK_TIMEOUT = 15000
...
// The receiving half of one link: ACK a token that parses, hand it to `ontoken`, then hang
// up once the sender confirms the ACK landed. `ontoken` is called for its side effect and
// not awaited here — the sender is waiting on the hangup, and the wallet work has nothing
// to say to it.
