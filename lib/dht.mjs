...
import { dhtOptions } from './net.mjs'
...
//
// Same shape as the bluetooth listener: links are handled concurrently while `ontoken` calls
// are queued, since they swap against a mint through a single wallet. A full queue withholds
// the ACK, leaving the sender's proofs safe rather than accumulating more work in memory.
//
